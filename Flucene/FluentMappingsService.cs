...
namespace Lucene.Net.Odm
{
    public class FluentMappingsService : IMappingsService
    {
        ...
        private Type GetMappingProviderType(Type mapType)
        {
            return mapType
                ...
                .FirstOrDefault(x => x.IsGenericType &&
                    x.GetGenericTypeDefinition() == (typeof(IDocumentMappingProvider<>)));
        }


        #region IFluentMappingsService Members

        public Document GetDocument<T>(T model, string prefix = null) where T : new()
        {
            object mapping;
        ...
        public object GetModel(Document doc, Type modelType, string prefix = null)
        {
            dynamic mapping;
